...
import { Plus, ChevronDown, ChevronUp, Globe, Check, ListTodo, Search } from "lucide-react";

/* ─── Ícone Nexus — flor colorida igual ao Brain do ClickUp ──────────────── */
function NexusIcon({ size = 32 }: { size?: number }) {
  return (
...
/* ─── Ícone colmeia para "Nexus" no botão ────────────────────────────────── */
