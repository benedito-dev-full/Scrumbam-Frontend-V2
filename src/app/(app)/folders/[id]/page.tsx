...
export default function FolderPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!entidade) {
    return <div style={{ color: "var(--muted-foreground)", padding: 40 }}>Pasta não encontrada.</div>;
  }
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "var(--background)", overflow: "hidden" }}>
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <div style={{ display: "grid", placeItems: "center", width: 22, height: 22, borderRadius: 5, background: "var(--accent)" }}>
            <IcFolder />
          </div>
          <button type="button" style={{ display: "flex", alignItems: "center", gap: 4, border: 0, background: "none", cursor: "pointer", color: "var(--foreground)", fontSize: 14, fontWeight: 600 }}>
            {entidade.nome}
            <IcCaret />
          </button>
          ...
          <div style={{ background: "var(--card)", borderRadius: 10, border: "1px solid var(--border)", padding: "16px 18px", minHeight: 200 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
              {recentes.length > 0 ? recentes.map((item) => (
                ...
                <p style={{ fontSize: 12, color: "var(--muted-foreground)" }}>Nada por aqui ainda</p>
              )}
            </div>
          </div>
