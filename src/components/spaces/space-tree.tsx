...
/**
 * Mini-menu dropdown que aparece ao clicar no "+" de um SpaceNode.
 * Permite escolher entre "Nova pasta" ou "Nova lista".
 */
      ...
      {menuOpen && (
        ...
        >
          <button
            type="button"
            role="menuitem"
            className="flex w-full items-center gap-2 px-3 py-1.5 text-[12px] text-popover-foreground hover:bg-accent"
            onClick={() => {
              setMenuOpen(false);
              onCreateFolder();
            }}
          >
            <IcFolder className="text-muted-foreground" />
            Nova pasta
          </button>
          <button
            type="button"
