...
const ALL_STATUS_VISUAL: StatusVisual[] = [
  "backlog",
  "pronto",
  "em-progresso",
  "concluido",
...
const ALL_PRIO_VISUAL = Object.keys(
  PRIO_CONFIG,
        ...
        >
          {(
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (abaAtiva !== id) e.currentTarget.style.color = "#a1a1aa";
              }}
              onMouseLeave={(e) => {
                if (abaAtiva !== id) e.currentTarget.style.color = "#6b6b74";
              }}
            >
              {label}
            </button>
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "20px 20px 0" }}>
              ...
              >
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setOpenDropdown(openDropdown === "lista" ? null : "lista")
                  }
                  style={{ ...chipStyle, maxWidth: 360 }}
                  title={
                    selectedList
                      ? `${selectedList.spaceName}${selectedList.folderName ? " › " + selectedList.folderName : ""} › ${selectedList.nome}`
                      : "Selecionar lista"
                  }
                >
                  <FolderTree
                    size={12}
                    style={{ color: "#7c6ff7", flexShrink: 0 }}
                  />
                  <span
                    style={{
                      fontSize: 12,
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Search
                          size={12}
                          style={{ color: "#6b6b74", flexShrink: 0 }}
                        />
                        <input
                          autoFocus
                          type="search"
